...
import { ClothesDryerRankingItem } from '@/app/types/clothes-dryer';
import { cleanItemName } from '@/app/lib/getClothesDryerData';

interface Props {
  item: ClothesDryerRankingItem;
}
